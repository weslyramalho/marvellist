import { Button, Card, CardContent, CardMedia, Container, Grid, Typography, CardActions, makeStyles } from '@material-ui/core';
...
export default function Creators() {
    ...
    useEffect(() => {
        api
        .get(`events?limit=${LIMIT}&offset=${offset}&ts=${time}&apikey=${publickey}&hash=${has}`)
        .then((response) => {
