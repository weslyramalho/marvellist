import { Card, CardContent, CardMedia, Container, Grid, Typography, CardActions, makeStyles } from '@material-ui/core';
...
export default function Characters() {
    ...
    useEffect(() => {
        api
        .get(`characters?limit=${LIMIT}&offset=${offset}$&ts=${time}&apikey=${publickey}&hash=${has}`)
        .then((response) => {
